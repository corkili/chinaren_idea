                                    ...
                                    <div class="well profile_view">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="right col-xs-5 text-center">
                                                <img src="headImage" alt="" class="img-circle img-responsive">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    <c:forEach items="${dateStrings}" var="date">
        dates.push('${date}');
    </c:forEach>

    <c:forEach items="${classNames}" var="cn">
        classNames.push('${cn}');
    </c:forEach>

    <c:forEach items="${counts}" var="classCounts" varStatus="i">
        tmp = [];
        <c:forEach items="${classCounts}" var="count" varStatus="j">
            tmp.push(${count});
        </c:forEach>
        classCounts.push({
            name: classNames[${i.index}],
            type: 'line',
            smooth: true,
            itemStyle: {
                normal: {
    ...
    // init chart
    var lineChart = echarts.init(document.getElementById('chart'), theme);
